  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: ({ theme }) => ({
        ...
        "gradient-1": `linear-gradient(-90deg, #4C9745, #A3D278)`,
        "gradient-2": `linear-gradient(-90deg, #FFC222, #95AA20)`,
        "gradient-3": `linear-gradient(-45deg, #B5B5B5, #FFFFFF, #E5E5E5)`,
        "gradient-4": `linear-gradient(-90deg, #B5B5B5 0%, #FFFFFF 60%, #E5E5E5 100%)`,
        "gradient-bg": `linear-gradient(-45deg, #FFE880, #FFE9F0 47%, #87FFD9 100%)`,
      }),
      backgroundPosition: {
        "pos-100-0": "100% 0%",
      },
    ...
    plugin(function ({
      ...
      addComponents({
        ...
        ".heading-title": {
          ...
          [`@media (min-width: ${theme("screens.xl")})`]: {
            fontSize: "calc(60/1920*100rem)", // 72
            lineHeight: "1.15",
          },
        },
        ".heading-1": {
        ...
        ".heading-1-subpage": {
          ...
          [`@media (min-width: ${theme("screens.xl")})`]: {
            fontSize: "calc(52/1920*100rem)", // 72
            lineHeight: "1.15",
          },
        },
        ".heading-2": {
        ...
        ".heading-5": {
          fontSize: "16px",
          [`@media (min-width: ${theme("screens.lg")})`]: {
            fontSize: "calc(18/1920*100rem)", // 6xl
            lineHeight: "1.35",
          },
        },
        ".heading-6": {
          fontSize: "14px",
          [`@media (min-width: ${theme("screens.lg")})`]: {
            fontSize: "calc(16/1920*100rem)", // 6xl
            lineHeight: "1.4",
          },
        },
        ".body-1": {
